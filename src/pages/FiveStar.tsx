...
// Updated with Kaaba View packages data
...
const PackagesHero = () => (
  <section className="relative py-20 overflow-hidden">
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
      ...
      <h1 className="text-4xl lg:text-5xl font-bold text-white font-display">5 Star Kaaba View Umrah Packages</h1>
    </div>
...
const UmrahPackageCard = ({ pkg }: { pkg: PackageItem }) => {
  ...
  const handleMoreDetails = () => {
    // Navigate to detail page with nights parameter
    navigate(`/packages/kaaba-view/${pkg.nights}`);
  };
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow overflow-hidden">
      ...
      <div className="p-5">
        ...
        {/* Button - Updated with navigation */}
        <button 
          onClick={handleMoreDetails}
          className="bg-noor-green text-white px-6 py-2.5 rounded-lg font-semibold text-sm hover:bg-[#2a5c3a] transition-colors flex items-center gap-2 w-full"
        >
          More Details
