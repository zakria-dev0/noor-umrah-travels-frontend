  ...
  <section className="py-16 bg-noor-light">
    <div className="max-w-4xl mx-auto px-4">
      <div className="prose prose-lg max-w-none">
        ...
        <p className="text-gray-600 leading-relaxed mb-4">
          Help is needed to get through the complicated planning of Umrah 2026. Haram Umrah Travels makes this process easier by giving you a clear way to pick the right options. We are easy to contact; you can call us at +1 786 9104615 or email info@haramumrahtravels.com. Our experienced travel agents are ready to help, making the whole process smooth, from thinking about it to booking it.
        </p>
