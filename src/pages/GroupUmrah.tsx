...
// Updated Special Promotions data with the new packages
const specialPromotionsData: PackageCategory[] = [
  {
    name: '5 Star Group Umrah Packages',
    subtitle: 'Noor Umrah Travels',
    packages: [
      { 
        title: 'Affordable Ramadan 1st Ashra Umrah Program', 
        nights: 10, 
        price: 1890, 
        image: 'img1', 
      ...
      { 
        title: 'Affordable Ramadan 2nd Ashra Umrah Program', 
        nights: 10, 
        price: 1890, 
        image: 'img2', 
        features: ['Visa Included', 'Transportation Included', '5 Star Hotels Included'] 
      ...
      { 
        title: 'Affordable Ramadan 3rd Ashra Umrah Program', 
        nights: 7, 
        price: 2450, 
        image: 'img3', 
        features: ['Visa Included', 'Transportation Included', '5 Star Hotels Included'] 
      ...
      { 
        title: 'Affordable September Group Umrah Program', 
        nights: 7, 
        price: 1890, 
        image: 'img1', 
        features: ['Visa Included', 'Flights Included', 'Transportation Included', '5 Star Hotels Included'] 
      },
    ],
  },
];
...
const PackagesHero = () => (
  <section className="relative py-20 overflow-hidden">
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
      ...
      <h1 className="text-4xl lg:text-5xl font-bold text-white font-display">5 Star Group Umrah Packages</h1>
    </div>
...
const GroupUmrah: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {specialPromotionsData.map((category, index) => (
