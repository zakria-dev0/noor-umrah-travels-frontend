  ...
  <div className="bg-noor-green text-white py-2.5 px-4">
    <div className="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-8">
        <a href="tel:3057768923" className="flex items-center gap-2 text-sm hover:text-noor-gold transition-colors">
          <PhoneIcon className="w-4 h-4 text-noor-gold" />
          3057768923
        </a>
        <a href="mailto:info@haramumrah" className="flex items-center gap-2 text-sm hover:text-noor-gold transition-colors">
