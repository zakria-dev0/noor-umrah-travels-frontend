      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 border-t border-gray-100 bg-gray-50/50">
          ...
          <a
            ...
            className="bg-white/[0.08] backdrop-blur-md border border-white/[0.15] text-white px-5 sm:px-6 py-3 rounded-full font-semibold hover:bg-white/15 transition-all text-xs sm:text-sm inline-flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
