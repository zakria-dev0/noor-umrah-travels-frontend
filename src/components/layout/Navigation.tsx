...
// //           isScrolled
// //             ? 'bg-white/98 backdrop-blur-lg shadow-lg shadow-black/[0.04]'
// //             : 'bg-white shadow-sm'
// //         }`}
// //       >
...
// //               <img
// //                 src={logo}
// //                 alt="Haram Umrah Travels"
// //                 className={`transition-all duration-300 ${
// //                   isScrolled ? 'h-11 md:h-14' : 'h-14 md:h-[72px]'
// //                 }`}
// //               />
// //             </Link>
...
// //                     isActive(link.to)
// //                       ? 'text-noor-green'
// //                       : 'text-gray-600 hover:text-noor-green hover:bg-noor-green/[0.03]'
// //                   }`}
// //                 >
// //                   {link.label}
// //                   {isActive(link.to) && (
// //                     <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-5 h-0.5 bg-noor-gold rounded-full" />
// //                   )}
// //                 </Link>
// //               ))}
// //             </div>
...
// //               <Link
// //                 to="/contact"
// //                 className={`hidden lg:inline-flex items-center gap-2 bg-noor-green text-white rounded-full font-semibold hover:bg-[#234d33] transition-all duration-200 hover:shadow-lg hover:shadow-noor-green/15 ${
...
// //               <button
// //                 onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
// //                 className="lg:hidden relative w-10 h-10 rounded-lg flex items-center justify-center hover:bg-gray-50 transition-colors"
// //                 aria-label="Toggle menu"
// //               >
// //                 <div className="w-5 flex flex-col items-center gap-[5px]">
// //                   <span
// //                     className={`h-[2px] bg-noor-green rounded-full transition-all duration-300 ${
// //                       mobileMenuOpen ? 'w-5 rotate-45 translate-y-[7px]' : 'w-5'
// //                     }`}
// //                   />
// //                   <span
// //                     className={`h-[2px] w-4 bg-noor-green rounded-full transition-all duration-300 ${
// //                       mobileMenuOpen ? 'opacity-0 scale-x-0' : ''
// //                     }`}
// //                   />
// //                   <span
// //                     className={`h-[2px] bg-noor-green rounded-full transition-all duration-300 ${
// //                       mobileMenuOpen ? 'w-5 -rotate-45 -translate-y-[7px]' : 'w-3'
// //                     }`}
// //                   />
// //                 </div>
// //               </button>
...
// //       {/* Mobile Menu Panel */}
// //       <div
// //         className={`fixed top-0 right-0 z-50 h-full w-[280px] sm:w-[320px] bg-white shadow-2xl transition-transform duration-300 ease-out lg:hidden ${
...
// //                 isActive(link.to)
// //                   ? 'text-noor-green bg-noor-green/5 border-l-2 border-noor-gold'
// //                   : 'text-gray-600 hover:text-noor-green hover:bg-gray-50'
// //               }`}
// //               onClick={() => setMobileMenuOpen(false)}
// //             >
// //               {link.label}
