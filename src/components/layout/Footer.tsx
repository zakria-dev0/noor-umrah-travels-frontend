...
//                   <a key={i} href="" className="w-9 h-9 bg-white/[0.06] rounded-lg flex items-center justify-center hover:bg-noor-gold/20 hover:border-noor-gold/20 border border-transparent transition-all">
