      ...
      <div className="border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {/* Phone */}
            <a href="tel:+1 786 9104615" className="flex items-center gap-3 sm:gap-4 hover:opacity-80 transition-opacity group">
              ...
              <div>
                ...
                <p className="font-bold text-sm sm:text-base">+1 786 9104615</p>
              </div>
            </a>
