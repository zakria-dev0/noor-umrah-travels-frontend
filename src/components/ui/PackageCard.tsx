...
// // 4-Star images (ADD YOUR OWN FILES)
// import star4img1 from '../../assets/images/packages/4-1.jpg';
// import star4img2 from '../../assets/images/packages/4-2.jpg';
// import star4img3 from '../../assets/images/packages/4-3.jpg';

// // 3-Star images (ADD YOUR OWN FILES)
// import star3img1 from '../../assets/images/packages/3-2.jpg';
// import star3img2 from '../../assets/images/packages/3-2.jpg';
// import star3img3 from '../../assets/images/packages/3-3.jpg';
...
// // Fallback images per star level
...
//             </div>
//             {days === 7 ? 'Visa & Ziyarat' : days === 10 ? 'Visa, Ziyarat & Guide' : 'Full package with guide'}
//           </div>
//           <div className="flex items-center gap-3 text-gray-600 text-sm">
//             <div className="w-8 h-8 bg-noor-green/5 rounded-lg flex items-center justify-center">
//               <StarIconSolid className="w-4 h-4 text-noor-gold" />
//             </div>
//             {stars} Star Hotels Included
//           </div>
//         </div>
...
//             className="flex-1 bg-noor-green text-white py-2.5 rounded-xl font-semibold text-sm hover:bg-[#2a5c3a] transition-colors flex items-center justify-center gap-2"
//           >
//             View Details <ArrowRightIcon className="w-3 h-3" />
//           </button>
//           <a
//             href="https://wa.me/19174007462"
//             target="_blank"
